...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Ankit Singh \vspace{2pt}} & % row = 1, col = 1
  Location: Meerut, Uttar Pradesh, India \\ % row = 1, col = 2
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Frameworks}{:}{React.js,  Express, Node.js}
...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Web Developer Intern}{Feb 2023 -- Present}
...
\section{Education}
  \resumeHeadingListStart{}
    \resumeQuadHeading{XII , City Vocational Public School}{Meerut, Uttar Pradesh}
    {(P.C.M) 72\%}{Apr 2018 -- May 2019}
...
\section{Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{\href{https://netflix-clone-theta-seven.vercel.app/}{\uline{Netflix Clone}}}{React.js, Redux, Firebase, Javascript, Git}{\href{https://netflix-clone-theta-seven.vercel.app/}{\uline{Link}}}
      \resumeItemListStart{}
      ...
      \resumeTrioHeading{Calorie Tracker}{Node.js, Express, JavaScript, Git}{\href{https://github.com/0205Ankit/CalorieTracker-Backend}{\uline{Source Code}}}
      \resumeItemListStart{}

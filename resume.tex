...
\section{Projects}
  ...
  \resumeTrioHeading{\href{https://app.falconai.in}{\uline{FalconAI}}}{Next.js, Prisma, Supabase, Typescript, TRPC, Git}{\href{https://app.falconai.in}{\uline{Link}}}
    ...
    \resumeTrioHeading{\href{https://chat-frame-coral.vercel.app/}{\uline{ChatFrame}}}{Next.js, Express.js, Typescript, TRPC, Socket.io,  Supabase, TailwindCSS}{\href{https://chat-frame-coral.vercel.app/
      ...
      \resumeItemListStart{}
        \resumeItem{Designed and implemented a comprehensive \textbf{real-time chat application} featuring seamless \textbf{photo-sharing} functionality and robust \textbf{interactivity}. }
        \resumeItem{Chat application encompassing both \textbf{one-to-one} and \textbf{group messaging} functionalities with \textbf{multiple} chat input methods, including \textbf{image} and \textbf{audio} sharing.}
        \resumeItem{Chats with \textbf{real-time}, \textbf{in-app notification} systems, ensuring prompt updates for incoming messages for enhanced user engagement.}

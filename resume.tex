...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Email: \href{mailto:ankitbisht0205@gmail.com}{\uline{ankitbisht0205@gmail.com}} $|$ % row = 2, col = 2
  Mobile: 9149301729 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Libraries}{:}{Radi, Redux/Redux toolkit, React Router}
  ...
  \resumeHeadingListStart{}
    \resumeTrioHeading{\href{https://clone-netflix-three-omega.vercel.app/}{\uline{Netflix Clone}}}{React.js, Redux, Firebase, Javascript, Git}{\href{https://clone-netflix-three-omega.vercel.app
      ...
      \resumeItemListStart{}
        ...
        \resumeItem{Deployed on Internet using Vercel}
      \resumeItemListEnd{}

      \resumeTrioHeading{\href{https://user-log.vercel.app/}{\uline{User-log}}}{Typescript , React.js, RTK Query, PostrgreSQL, Express, Prisma}{\href{https://user-log.vercel.app/}{\uline{Link}}}
      \resumeItemListStart{}
        \resumeItem{A basic \textbf{Full-stack} CRUD app using  \textbf{React, PostresSQL,Express,AWS S3}}
        \resumeItem{Let's you log user with their details and an \textbf{Image}}
        \resumeItem{\textbf{Database} is hosted on Vercel PostreSQL}
      \resumeItemListEnd{}

      \resumeTrioHeading{Calorie Tracker}{Typescript , Node.js, Express, Git}{\href{https://github.com/0205Ankit/CalorieTracker-Backend}{\uline{Source Code}}}
      \resumeItemListStart{}
      \resumeItem {API which lets you manage and keep track of your meal and calorie intake}
